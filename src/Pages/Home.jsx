  ...
  return (
    <div>
      ...
      <div className="shop-by-age section-padding ">
              <div className="d-flex  justify-content-center  pb-5"><h3 >Shop by age</h3></div>
      ...
      {/* new-arrival-section?-end */}  
       ...
       <div className="different-in-market-section section-padding justify-content-between">
                <div className='d-flex justify-content-center pb-5'><h3>What makes us different in the market?</h3></div>
          ...
          <div className="reviews-wrapper-card d-flex gap-5">
            <div className="reviews-card 1">
              <div className="reviewesbx">
                ...
                <div>
                  <p className="m-0">I brought for my 6 years old girl.. </p>
                  <p>
                    <a
                      href="#"
                      className="text-decoration-none text-secondary showmoretxt"
                    >
                      Show more
                      <RiArrowDropDownLine />
                    </a>
            ...
            <div className="reviews-card 3">
              <div className="reviewesbx">
                ...
                <div>
                  <p className="m-0">I want to thank toy owner </p>
                  <p>
                    <a
                      href="#"
                      className="text-decoration-none text-secondary showmoretxt"
